        ...
        "admin.admin_operations": ToolSchema(
            ...
            parameters=[
                ParameterSchema(
                    ...
                    required=True,
                    choices=["settings", "users", "streams", "export", "import"],
                    basic_param=True,
                ),
                ParameterSchema(
                    name="realm_id",
                    type="int",
                    description="Realm ID for operation",
                    advanced_param=True,
                ),
                ParameterSchema(
                    name="settings",
        ...
        "admin.customize_organization": ToolSchema(
            ...
            parameters=[
                ParameterSchema(
                    ...
                    required=True,
                    choices=["emoji", "linkifiers", "playgrounds", "filters"],
                    basic_param=True,
                ),
                ParameterSchema(
                    name="emoji_name",
                ...
                ParameterSchema(
                    name="emoji_file",
                    type="bytes",
                    description="Emoji image data",
                    basic_param=True,
                ),
                ParameterSchema(
                    name="pattern",
                    type="str",
                    description="Linkifier pattern",
                    basic_param=True,
                ),
                ParameterSchema(
                    name="url_format",
                    type="str",
                    description="Linkifier URL format",
                    basic_param=True,
                ),
                ParameterSchema(
                    name="playground_name",
                    type="str",
                    description="Code playground name",
                    advanced_param=True,
                ),
                ParameterSchema(
                    name="url_prefix",
                    type="str",
                    description="Playground URL prefix",
                    advanced_param=True,
                ),
                ParameterSchema(
                    name="language",
