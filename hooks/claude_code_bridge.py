...
class ClaudeCodeZulipBridge:
    ...
    def _call_mcp_tool(self, request_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def handle_post_tool_use(self, hook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if tool_name == "Task":
            ...
            self._send_agent_message(
                ...
                content=f"Completed subagent task",
    ...
    def _send_agent_message(self, message_type: str, content: str, metadata: Optional[Dict] = None):
    ...
    def _send_status_update(self, status: str, current_task: str, metadata: Optional[Dict] = None):
    ...
    def _request_user_input(self, question: str, context: Dict, options: Optional[list] = None) -> Optional[str]:
    ...
    def _wait_for_response(self, request_id: str, timeout: int = 60) -> Optional[str]:
