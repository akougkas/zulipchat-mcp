...
class TestEventManagement:
    ...
    def mock_deps(self, mock_client):
        """Patch dependencies."""
        with patch("src.zulipchat_mcp.tools.event_management.ConfigManager"), \
             patch("src.zulipchat_mcp.tools.event_management.ZulipClientWrapper") as mock_wrapper:
    ...
    async def test_register_invalid_event_type(self, mock_deps):
        ...
        mock_deps.register.return_value = {"result": "error", "msg": "Invalid event type"}
    ...
    async def test_get_events_expired_queue(self, mock_deps):
        ...
        mock_deps.get_events.return_value = {"result": "error", "msg": "Bad event queue id"}
    ...
    async def test_deregister_nonexistent_queue(self, mock_deps):
        ...
        mock_deps.deregister.return_value = {"result": "error", "msg": "Bad event queue id"}
