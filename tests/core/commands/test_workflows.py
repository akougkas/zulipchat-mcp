...
from src.zulipchat_mcp.core.commands.engine import ExecutionContext, ExecutionStatus
...
class TestChainBuilder:
    ...
    def mock_client(self):
        ...
        client.get_messages_from_stream.return_value = {"result": "success", "messages": []}
    ...
    def test_create_message_workflow(self, mock_client):
        ...
        mock_client.send_message.assert_called_with("stream", "general", "hello", "test")
    ...
    def test_create_digest_workflow(self, mock_client):
        ...
        mock_client.get_messages_from_stream.side_effect = [
            {"result": "success", "messages": [{"sender_full_name": "Alice", "content": "Hi", "id": 1}]},
            {"result": "success", "messages": [{"sender_full_name": "Bob", "content": "Bye", "id": 2}]}
        ]
    ...
    def test_create_daily_summary_workflow(self, mock_client):
        ...
        mock_client.get_messages_from_stream.return_value = {"result": "success", "messages": []}
