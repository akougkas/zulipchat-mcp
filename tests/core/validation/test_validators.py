...
class TestParameterValidator:
    ...
    def validator(self, mock_schemas):
        with patch("src.zulipchat_mcp.core.validation.validators.get_all_schemas", return_value=mock_schemas):
    ...
    def test_validate_happy_path(self, validator):
        ...
        result = validator.validate_tool_params("test_tool", params, ValidationMode.ADVANCED)
    ...
    def test_validate_union_type(self, validator):
        ...
        result = validator.validate_tool_params("test_tool", params_str, ValidationMode.ADVANCED)
        assert result["union_param"] == "text"

        params_int = {"req_basic": "s", "req_adv": True, "union_param": 123}
        result = validator.validate_tool_params("test_tool", params_int, ValidationMode.ADVANCED)
        ...
        with pytest.raises(ValidationError, match="Expected one of"):
            validator.validate_tool_params("test_tool", params_bad, ValidationMode.ADVANCED)

    def test_validate_missing_required(self, validator):
        """Test missing required param."""
        params = {"opt_basic": 1}
        with pytest.raises(ValidationError, match="Required parameter 'req_basic' is missing"):
    ...
    def test_validate_unknown_param_expert(self, validator):
        ...
        result = validator.validate_tool_params("test_tool", params, ValidationMode.EXPERT)
    ...
    def test_validate_narrow_filters(self, validator):
        ...
        from src.zulipchat_mcp.core.validation.narrow import NarrowFilter, NarrowOperator
    ...
    def test_get_tool_help(self, validator):
        ...
        assert "req_adv" not in names # unless req_adv is marked basic_param=False in fixture
