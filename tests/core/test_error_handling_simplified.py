...
class TestRateLimiter:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_acquire_with_tokens(self, rate_limiter: RateLimiter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_acquire_without_tokens(self, rate_limiter: RateLimiter) -> None:
